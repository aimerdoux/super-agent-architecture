...
const FUNCTION_URL = process.env.SUPABASE_URL
  ? `${process.env.SUPABASE_URL}/functions/v1/self-upgrade`
  : 'https://xnzxnhlwabbhnxjxwwyn.functions.supabase.co/self-upgrade';
...
const data = JSON.stringify({ action: 'health' });
